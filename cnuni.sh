...
gem install lolcat
bash <(curl -Ls https://raw.githubusercontent.com/Bishu9/script/main/python.sh)
...
bash <(curl -Ls https://raw.githubusercontent.com/Bishu9/script/main/dropbear.sh)
bash <(curl -Ls https://github.com/Bishu9/script.git/dropbear.sh)
bash <(curl -Ls https://raw.githubusercontent.com/Bishu9/script/main/sshconfing.sh)
bash <(curl -Ls https://raw.githubusercontent.com/Bishu9/script/main/dns.sh)
